...
function MovieCard({ movie, deleteMovie }) {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-yellow-500 bg-zinc-900/80 shadow-lg backdrop-blur-md transition hover:shadow-yellow-500/40">
      <img
      ...
      <div className="p-4 sm:p-5">
        <h2 className="mb-2 text-xl font-bold text-yellow-400 sm:text-2xl">{movie.title}</h2>
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-red-600 px-4 py-2 font-semibold transition-all duration-300 hover:bg-red-700"
        >
          <FaTrash /> Delete
        </button>
      </div>
